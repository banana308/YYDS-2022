...
class betting_odds(object):
    ...
    def single_bet(self, credit_odds_list, bet_amount, level3_retreat_proportion):
        odds = credit_odds_list
        win_amount = odds * bet_amount - bet_amount
        backwater_amount = level3_retreat_proportion * bet_amount
        rebate_amount = win_amount + backwater_amount + bet_amount

        print(f"\033[31m单注的总赔率：{credit_odds_list}\033[0m")
        return rebate_amount

    def stray_bet(self, credit_odds_list, bet_amount):

        # 计算赔率
        odds = 1
        for j in credit_odds_list:
            odds_stray_bet = odds * j
        print(f"\033[32m注单：{order_no}，串关{len(credit_odds_list)}串1的总赔率为：{odds_stray_bet}\033[0m")

        return odds_stray_bet



    def Duplex_2_3(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        ...
        AC = dict['A'] * dict['C']
        odds_2_3 = AB + BC + AC
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2]}的总赔率为：{odds_2_3}\033[0m")

        return odds_2_3

    def Duplex_3_4(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2]}的总赔率为：{odds_3_4}\033[0m")

        return odds_3_4

    def Duplex_2_6(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        Duplex = {"4串11": [4_1_0, 3_4_0, 2_6_0]}
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2]}的总赔率为：{odds_2_6}\033[0m")

        return odds_2_6

    def Duplex_4_5(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2]}的总赔率为：{odds_4_5}\033[0m")

        return odds_4_5

    def Duplex_3_10(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        Duplex = {"5串26": [5_1_0, 4_5_0, 3_10_0, 2_10_0]}
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2:3]}的总赔率为：{odds_3_10}\033[0m")

        return odds_3_10

    def Duplex_2_10(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        Duplex = {"5串26": [5_1_0, 4_5_0, 3_10_0, 2_10_0]}
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2:3]}的总赔率为：{odds_2_10}\033[0m")

        return odds_2_10

    def Duplex_5_6(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2]}的总赔率为：{odds_5_6}\033[0m")

        return odds_5_6

    def Duplex_4_15(self, mix_num, credit_odds_list, bet_amount, AB_list, dict):
        Duplex = {"6串57": [6_1_0, 5_6_0, 4_15_0, 3_20_0, 2_15_0]}
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2:3]}的总赔率为：{odds_4_15}\033[0m")

        return odds_4_15

    def Duplex_3_20(self,credit_odds_list, bet_amount, AB_list, dict):
        Duplex = {"6串57": [6_1_0, 5_6_0, 4_15_0, 3_20_0, 2_15_0]}
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2:3]}的总赔率为：{odds_3_20}\033[0m")

        return odds_3_20

    def Duplex_2_15(self,credit_odds_list, bet_amount, AB_list, dict):
        Duplex = {"6串57": [6_1_0, 5_6_0, 4_15_0, 3_20_0, 2_15_0]}
        for i in range(0, len(credit_odds_list)):
            dict[AB_list[i]] = credit_odds_list[i]
        # 计算赔率：
        ...
        print(f"\033[32m注单：{order_no}复式串关{list(mix_num)[0]}串1*{list(mix_num)[2:3]}的总赔率为：{odds_2_15}\033[0m")

        return odds_2_15

    def Duplex_bet(self, credit_odds_list, bet_amount,AB_list,dict):
        ...
        if mix_num==str(3_4_1):
            self.Duplex_2_15(mix_num=mix_num, credit_odds_list=credit_odds_list, bet_amount=bet_amount, AB_list=AB_list, dict=dict)
            self.stray_bet(mix_num, credit_odds_list, bet_amount)
...
class BetController(object):
    ...
    def order_no(self,bet_type,status):
        global order_no
        """
        ...
        if bet_type==0:
            sql = f"SELECT order_no FROM o_account_order WHERE STATUS={status}"
            sum = self.my.query_data(sql, db_name='bfty_credit')
        elif bet_type==4:
            sql = f"SELECT order_no FROM o_account_order WHERE STATUS={status} AND bet_type!=1"
            sum = self.my.query_data(sql, db_name='bfty_credit')
        else:
            sql = f"SELECT order_no FROM o_account_order WHERE STATUS={status} AND bet_type={bet_type}"
            sum = self.my.query_data(sql, db_name='bfty_credit')
        ...
        for order_no in order_no_lsit:
            bet_type(self, order_no=order_no)

        return order_no_lsit


    def bet_type(self,order_no):
        global bet_amount,level3_retreat_proportion,mix_num
        """
        @判断注单的类型：bet_type:1(单注)，bet_type:2(串关)，bet_type:3(复式串关)
        @根据类型调用相应的函数进行结算
        """
        sql =f"SELECT bet_type,mix_num,bet_amount,level3_retreat_proportion FROM o_account_order WHERE STATUS=1 AND order_no={order_no}"
        sum = self.my.query_data(sql, db_name='bfty_credit')
        print(sum)
        ...
        self.credit_odds(self, order_no=order_no)

        return bet_type,mix_num,bet_amount,level3_retreat_proportion

    def credit_odds(self,order_no):
        """
        @根据注单类型查询其赔率
        @根据赔率进行计算
        """
    ...
    def Calculate_odds(self, credit_odds_list,bet_type,mix_num):
        print(credit_odds_list)
        """
        ...
        if bet_type==1:
            self.single_bet(self,credit_odds_list=credit_odds_list,bet_amount=bet_amount,level3_retreat_proportion=level3_retreat_proportion)
        elif bet_type==2:
