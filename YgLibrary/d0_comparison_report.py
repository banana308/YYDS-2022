...
if __name__ == "__main__":
    ...
    for pkk in range(0,1):
        ...
        # print(time_new_list)
        # 调用本地Exce读取数据
        toten='eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjE1MzE1MTYwMTc4NDc4Njk0NDIiLCJleHAiOjE2NTY0MDg4NzUsInVzZXJuYW1lIjoiZDAifQ.XAZY_VIgWh1nFtHKzhV68glC8CKos1Ir6noDFwpo7VU'
        ccds=cc.reading_Excel(excel=excel, save_excel=save_excel,begin="2022-06-15",end="2022-06-21", URL=URL)
